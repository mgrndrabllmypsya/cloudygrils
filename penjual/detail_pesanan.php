...
<div class="main">
    <div class="topbar">
        <div class="topbar-left">
            ...
            <div style="display:flex;align-items:center;gap:12px;"><button class="btn-toggle-sidebar" onclick="toggleSidebar()"><i class="bi bi-list"></i></button><div class="topbar-title">Detail Pesanan</div></div>
        </div>
